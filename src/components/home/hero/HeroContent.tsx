  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col sm:flex-row gap-3 pt-2">
        <Button 
          size="lg"
          className="bg-[#9b87f5] hover:bg-[#7E69AB] text-white group transition-all duration-300 text-lg px-6 py-5"
        >
          Get Started
        ...
        <Button
          size="lg"
          variant="outline"
          className="border-2 border-[#D6BCFA] text-[#D6BCFA] hover:bg-[#D6BCFA]/10 text-lg px-6 py-5"
        >
          Watch Demo
        </Button>
      </div>
      ...
      <div className="relative max-w-xl pt-2">
        <Input 
          ...
          className="w-full pl-12 pr-4 py-5 rounded-full bg-white/90 backdrop-blur-sm border-2 border-[#9b87f5]/10 focus:border-[#9b87f5] text-lg"
        />
        ...
        <div className="flex -space-x-3">
          {[1, 2, 3, 4].map((i) => (
            <img
              ...
              alt={`User ${i}`}
              className="w-8 h-8 rounded-full border-2 border-[#1A1F2C]"
            />
          ))}
        </div>
